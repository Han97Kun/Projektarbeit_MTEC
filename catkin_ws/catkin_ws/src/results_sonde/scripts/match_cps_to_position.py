...
# -----------------------------
DISCARD_HEAD = 3   # wie viele Messungen am Anfang ignorieren
DISCARD_TAIL = 3   # wie viele Messungen am Ende ignorieren
...
def find_series_csv_via_folder_raster(z, x, y):
    # wenn ich das rechteckige raster fahre
    htag = height_tag_from_z(z)
